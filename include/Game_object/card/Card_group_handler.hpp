...
private:
    ...
    const std::shared_ptr<Draw::ReTexture>&reticleBlock_img=RUtil::Image_book::GetTexture(RESOURCE_DIR"Image/combat/reticleBlock.png"),&reticleArrow_img=RUtil::Image_book::GetTexture(RESOURCE_DIR"Image/combat/reticleArrow.png");

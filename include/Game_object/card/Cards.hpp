...
private:
    int m_text_pos;
    float current_x,current_y,m_color_a,m_draw_scale,m_angle,m_type_width,m_type_offset;
    ...
    static constexpr Uint32 FRAME_SHADOW_COLOR=0,DEFAULT_COLOR=RUtil::Math::GetColorUint32_RGB(255,255,255),TYPE_COLOR=RUtil::Math::GetColorUint32_RGB(0.35F,0.35F,0.35F);

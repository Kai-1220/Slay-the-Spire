...
#
get_filename_component(filename "C:/Users/Billy/Desktop/oop_project/Slay-the-Spire/build/_deps/sdl2-tmp/SDL2-2.26.5.zip" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-sdl2${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-sdl2${i}")

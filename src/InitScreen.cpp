...
void InitScreen::CreateBackground(){
    ...
    BackgroundMaterices.m_Model = glm::scale(BackgroundMaterices.m_Model, glm::vec3{glm::vec2{1920.0f*WindowMultwidth,1469.0f*WindowMultheight*0.73}/Background->Get_small_Size(), 1});
    BackgroundMaterices.m_Model = glm::translate(BackgroundMaterices.m_Model, glm::vec3(0.0f, 0.0f, -3.0f));
    Background->Draw(BackgroundMaterices);
}
void InitScreen::CreateTower(){
    ...
    TowerMaterices.m_Model = glm::scale(TowerMaterices.m_Model, glm::vec3{glm::vec2{1920.0f*WindowMultwidth,1266.0f*WindowMultheight*0.84}/Tower->Get_small_Size(), 1});
    TowerMaterices.m_Model = glm::translate(TowerMaterices.m_Model, glm::vec3(0.0f, 0.0f, -2.0f));
    Tower->Draw(TowerMaterices);
}

...
void InitScreen::CreateBackground(){
    ...
    Matrices.m_Model = glm::scale(Matrices.m_Model, glm::vec3{glm::vec2{1920.0f*Setting::SCALE,1469.0f*Setting::SCALE*0.8}/Background->Get_small_Size(), 1});
...
void InitScreen::CreateTower(){
    ...
    Matrices.m_Model = glm::scale(Matrices.m_Model, glm::vec3{glm::vec2{1920.0f*Setting::SCALE,1266.0f*Setting::SCALE*0.85}/Tower->Get_small_Size(), 1});
...
void InitScreen::CreateBlackCloud(int i){
    ...
    BlackCloudMaterices.m_Model = glm::scale(BlackCloudMaterices.m_Model, glm::vec3{BlackCloudorigScale*glm::vec2{Setting::SCALE,Setting::SCALE}*glm::vec2{0.3,0.3}/BlackCloud->Get_small_Size(), 1});
...
void InitScreen::CreateWhiteCloud(int i){
    ...
    WhiteCloudMaterices.m_Model = glm::scale(WhiteCloudMaterices.m_Model, glm::vec3{WhiteCloudorigScale*glm::vec2{Setting::SCALE,Setting::SCALE}*glm::vec2{0.3,0.3}/WhiteCloud->Get_small_Size(), 1});

...
>>>>>>> db3deca3787c228469bc5332f1a13a3ae9ec37d0
    ...
    data3=Util::ConvertToUniformBufferData(Util::Transform(), test3->GetSize(), 0);
    data3.m_Model = glm::scale(data3.m_Model, glm::vec3{0.1,0.1, 0});
